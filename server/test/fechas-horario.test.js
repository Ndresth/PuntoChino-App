...
test('estado: lunes a sábado 11:30–18:30, domingos y festivos 11:30–15:30', () => {
    ...
    assert.equal(e('2026-09-23T23:31:00Z').abierto, false); // mié 18:31
    assert.equal(e('2026-09-27T20:00:00Z').abierto, true); // dom 15:00
    assert.equal(e('2026-09-27T20:31:00Z').abierto, false); // dom 15:31
    assert.equal(e('2026-10-12T21:00:00Z').abierto, false); // festivo 16:00
