...
export default function OrdersPanel() {
  ...
  // Función para manejar la impresión según el tipo (cocina o cliente)
  const handleImprimir = (orden, tipo) => {
    ...
    // Llamamos a la función de impresión pasándole el TIPO ('cocina' o 'cliente')
            ...
            {ordenes.map(orden => (
                <div key={orden._id} className="col-md-6 col-lg-4 mb-4">
                    <div className={`card shadow h-100 ${orden.tipo === 'Mesa' ? 'border-primary' : 'border-warning'}`}>
                        ...
                        {/* FOOTER CON LOS 3 BOTONES NUEVOS */}
